...
##### Rationale
As mission and business processes and the threat environment change, security requirements and technical protection methods must be updated. IT-related risks to the mission/business vary over time and undergo periodic assessment.
##### Implications
...
##### Rationale
Vulnerabilities are at hardware,firmwire, virtualization, middleware and application layers. 
...
##### Rationale
Secure defaults lower the risk of bad configurations.
##### Implications
